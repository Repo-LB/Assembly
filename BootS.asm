...
Main_Boot_Init: 
    ...
    JMP Disk_Reset                                ;2; JMP Moves Instruction Pointer [CS:IP] 	
    CLI                                           ;1; Disable Interrupts
    HLT                                           ;1; Stops CPU Execution	
	
Main_Boot_Success:
	POPF	                                      ;1; Restore FLAGS From Stack
	JMP 0x50:0x0                                  ;5; JMP Moves Instruction Pointer [CS:IP] 		
	CLI                                           ;1; Disable Interrupts
	HLT                                           ;1; Stops CPU Execution	
...
Disk_ReadSector_Fail:
    CLC                                           ;1; Clear The Carry Flag
	JMP Disk_ReadSector                           ;2; JMP Moves Instruction Pointer [CS:IP] 
    CLI                                           ;1; Disable Interrupts
    HLT                                           ;1; Stops CPU Execution
